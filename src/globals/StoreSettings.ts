            ...
            },
            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  type: 'checkbox',
                  defaultValue: true,
                  label: 'Mostrar retirar en la tienda',
                },
                {
                  name: 'storePickupName',
                  type: 'text',
                  defaultValue: 'Retirar en la tienda',
                  label: 'Nombre retiro en tienda',
                },
                {
                  name: 'storePickupEta',
                  type: 'text',
                  defaultValue: 'Cuando te avisemos que está listo',
                  label: 'Plazo retiro en tienda',
                  admin: { description: 'El costo es siempre $0.' },
                },
                {
                  name: 'ownMessengerEnabled',
                  type: 'checkbox',
                  defaultValue: true,
                  label: 'Mostrar mensajero de confianza',
                },
                {
                  name: 'ownMessengerName',
                  type: 'text',
                  defaultValue: 'Usar mensajero de mi confianza',
                  label: 'Nombre mensajero de confianza',
                },
                {
                  name: 'ownMessengerEta',
                  type: 'text',
                  defaultValue: 'A coordinar',
                  label: 'Plazo mensajero de confianza',
                  admin: { description: 'El costo es siempre $0. El cliente usa su propio mensajero.' },
                },
              ],
            },
            {
