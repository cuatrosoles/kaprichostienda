...
export const Products: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      name: 'sizeGuide',
      type: 'array',
      label: 'Medidas por talle',
      labels: { singular: 'Talle', plural: 'Talles' },
      admin: {
        description:
      ...
      fields: [
        {
          ...
          required: true,
          label: 'Talle',
          admin: { description: 'Ej: T3, T4, 3, M' },
        },
        ...
        { name: 'peso', type: 'text', label: 'Peso' },
      ],
    },
    {
      name: 'detalle',
      ...
      label: 'Detalle',
      admin: {
        description: 'Texto extra de la prenda (puntilla, tela, etc.). Cada Enter es una línea nueva.',
      },
    },
    { name: 'ancho', type: 'text', admin: { hidden: true } },
    { name: 'alto', type: 'text', admin: { hidden: true } },
    { name: 'largo', type: 'text', admin: { hidden: true } },
    { name: 'manga', type: 'text', admin: { hidden: true } },
    { name: 'hombro', type: 'text', admin: { hidden: true } },
    { name: 'sisa', type: 'text', admin: { hidden: true } },
    { name: 'talle', type: 'text', admin: { hidden: true } },
    { name: 'numero', type: 'text', admin: { hidden: true } },
    { name: 'peso', type: 'text', admin: { hidden: true } },
